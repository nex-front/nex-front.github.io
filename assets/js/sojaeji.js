...
sojaeji.prototype = {
 ...
 '시도' : ['도시','경기','서울','부산','인천','광주','대전','세종','울산','강원','대구','경남','경북','전남','전북','제주','충남','충북'],
 '세종' : ['세종특별자치시'],
 ...
 '경기' : ['용인시 기흥구','용인시 수지구','용인시 처인구','고양시 덕양구','고양시 일산동구','고양시 일산서구','과천시','광명시','광주시','구리시','군포시','김포시','남양주시','동두천시','부천시 소사구','부천시 오정구','부천시 원미구','성남시 분당구','성남시 수정구','성남시 중원구','수원시 권선구','수원시 영통구','수원시 장안구','수원시 팔달구','시흥시','안산시 단원구','안산시 상록구','안성시','안양시 동안구','안양시 만안구','양주시','오산시','의왕시','의정부시','이천시','파주시','평택시','포천시','하남시','화성시','가평군','양평군','여주군','연천군'],
 ...
 '도시' : ['시/구/군'],
 '도시->시/구/군' : ['읍/면/동'],
 '세종->세종특별자치시' : ['반곡동','소담동','보람동','대평동','가람동','한솔동','나성동','새롬동','다정동','어진동','종촌동','고운동','아름동','도담동','조치원읍','연기면','연동면','부강면','금남면','장군면','연서면','전의면','전동면','소정면'],
 ...
 '충남->공주시' : ['계룡면','금학동','반포면','사곡면','신관동','신풍면','옥룡동','우성면','웅진동','유구읍','의당면','이인면','장기면','정안면','중학동','탄천면'],
 '충남->금산군' : ['군북면','금산읍','금성면','남이면','남일면','복수면','부리면','제원면','진산면','추부면'],
 '충남->논산시' : ['가야곡면','강경읍','광석면','노성면','벌곡면','부적면','부창동','상월면','성동면','양촌면','연무읍','연산면','은진면','채운면','취암동'],
 '충남->당진시' : ['고대면','당진1동','당진2동','당진3동','대호지면','면천면','석문면','송산면','송악읍','순성면','신평면','우강면','정미면','합덕읍'],
 '충남->보령시' : ['남포면','대천1동','대천2동','대천3동','대천4동','대천5동','미산면','성주면','오천면','웅천읍','주교면','주산면','주포면','천북면','청라면','청소면'],
 '충남->부여군' : ['구룡면','규암면','남면','내산면','부여읍','석성면','세도면','양화면','옥산면','외산면','은산면','임천면','장암면','초촌면','충화면','홍산면'],
 '충남->서산시' : ['고북면','대산읍','동문1동','동문2동','부석면','부춘동','석남동','성연면','수석동','운산면','음암면','인지면','지곡면','팔봉면','해미면'],  
 '충남->서천군' : ['기산면','마산면','마서면','문산면','비인면','서면','서천읍','시초면','장항읍','종천면','판교면','한산면','화양면'],
 '충남->아산시' : ['도고면','둔포면','배방읍','선장면','송악면','신창면','염치읍','영인면','온양1동','온양2동','온양3동','온양4동','온양5동','온양6동','음봉면','인주면','탕정면'],
 '충남->예산군' : ['고덕면','광시면','대술면','대흥면','덕산면','봉산면','삽교읍','신암면','신양면','예산읍','오가면','응봉면'],   
 '충남->천안시 동남구' : ['광덕면','동면','목천읍','문성동','병천면','봉명동','북면','성남면','수신면','신방동','신안동','원성1동','원성2동','일봉동','중앙동','청룡동','풍세면'],
 '충남->천안시 서북구' : ['백석동','부성동','성거읍','성정1동','성정2동','성환읍','쌍용1동','쌍용2동','쌍용3동','입장면','직산읍'],
 '충남->청양군' : ['남양면','대치면','목면','비봉면','운곡면','장평면','정산면','청남면','청양읍','화성면'],
 '충남->태안군' : ['고남면','근흥면','남면','소원면','안면읍','원북면','이원면','태안읍'],
 '충남->홍성군' : ['갈산면','결성면','광천읍','구항면','금마면','서부면','은하면','장곡면','홍동면','홍북면','홍성읍'],
 ...
 '충북->제천시' : ['고암','모산동','교동','금성면','남천','동현동','덕산면','백운면','봉양읍','서부','영천동','송학면','수산면','신백','두학동','용두동','중앙','의림','명동','청전동','청풍면','한수면','화산동'],
 '충북->증평군' : ['도안면','증평읍'],
 '충북->진천군' : ['광혜원면','덕산면','문백면','백곡면','이월면','진천읍','초평면'],
 '충북->청원군' : ['가덕면','강내면','남이면','남일면','낭성면','내수읍','문의면','미원면','부용면','북이면','오송읍','오창읍','옥산면','현도면'],
 '충북->청주시상당구' : ['금천동','내덕제1동','내덕제2동','성안동','영운동','오근장동','용담','명암','산성동','용암1동','용암2동','우암동','율량','사천동','중앙동','탑대성동'],
 '충북->청주시흥덕구' : ['가경동','강서제1동','강서제2동','모충동','복대1동','복대2동','봉명1동','봉명2','송정동','분평동','사직제1동','사직제2동','사창동','산남동','성화','개신','죽림동','수곡1동','수곡2동','운천','신봉동'],
 '충북->충주시' : ['가금면','교현','안림동','교현2동','금가면','노은면','달천동','대소원면','동량면','목행','용탄동','문화동','봉방동','산척면','살미면','성내','충인동','소태면','수안보면','신니면','앙성면','엄정면','연수동','용산동','주덕읍','지현동','칠금','금릉동','호암','직동']
