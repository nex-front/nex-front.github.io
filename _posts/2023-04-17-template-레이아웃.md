...
{% include codepen.html hash="VwEjVEj" title="templete skin layout css (temp_header_skin1)" %}
...
{% include codepen.html hash="XWxKoVd" title="templete skin layout markup (temp_header_skin1)" %}